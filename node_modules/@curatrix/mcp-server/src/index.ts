...
import { applyFixes, scanProject, type Issue, type ScanResult } from "@curatrix/core";
...
function serializeScanResult(result: unknown, format: "json" | "text"): string {
  if (format === "text") {
    return [
...
function correctionConfidence(issue: Issue): number {

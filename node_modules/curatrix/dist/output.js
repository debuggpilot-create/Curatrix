...
export function renderText(result, useColor = false) {
...
export function renderFixPreview(issue, patchPreview, useColor = false) {
    return [
...
export function renderFixResult(issue, result, useColor = false) {
...
function appendSection(lines, title, issues, colorName, useColor) {
